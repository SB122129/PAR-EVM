...
export class EvmSignerService {
  ...
  private readonly allowUnlockedRpcSendTx = env.EXPO_PUBLIC_EVM_ALLOW_RPC_SEND_TRANSACTION === 'true';
  ...
  private async waitForReceipt(
    ...
    return this.executionFrom('pending', 'rpc', txHash, 'Timed out waiting for receipt confirmation.');
  }
