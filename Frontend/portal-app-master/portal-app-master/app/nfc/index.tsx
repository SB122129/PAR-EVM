  ...
  const getErrorMessage = (): string => {
    ...
    switch (errorType) {
      ...
      case 'invalid_portal_url':
        return 'NFC tag does not contain a valid PAR URL. Make sure you are scanning a PAR-compatible tag.';
      case 'scan_cancelled':
            ...
            scanState === 'error' ? (
              <>
                ...
                {errorType === 'invalid_portal_url' && (
                  <>
                    <ThemedText style={[styles.instructionItem, { color: secondaryTextColor }]}>
                      • This tag does not contain a PAR-compatible URL
                    </ThemedText>
                    <ThemedText style={[styles.instructionItem, { color: secondaryTextColor }]}>
                      • Make sure you are scanning a PAR NFC tag
                    </ThemedText>
                    <ThemedText style={[styles.instructionItem, { color: secondaryTextColor }]}>
                      • Try scanning a different PAR tag
                    </ThemedText>
                  </>
                )}
