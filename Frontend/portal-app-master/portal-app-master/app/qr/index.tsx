...
import { parseCashuToken, parseKeyHandshakeUrl } from '@/utils/mockNative';
...
export default function QRScannerScreen() {
    ...
    switch (mode) {
      ...
      case 'main':
        ...
        try {
          ...
          return {
            isValid: false,
            error: 'Invalid QR code. Please scan a valid PAR authentication QR code.',
          };
        }
        break;
      case 'ticket':
  ...
  const getHeaderTitle = () => {
    switch (mode) {
      ...
      case 'lightning':
        return 'Scan a PAR subscription request';
      default:
  ...
  const getInstructionText = () => {
    switch (mode) {
      ...
      default:
        return 'Point your camera at a PAR authentication QR code';
    }
  };
