  ...
  return (
    <View style={styles.welcomeContainer}>
      ...
      >
        ...
        >
          Set up your first demo payment
        </ThemedText>
        ...
        <ThemedText
          ...
          lightColor={Colors.gray700}
        >
          Simulate onboarding funds and start showing payment, ticket, and subscription flows.
        </ThemedText>
        ...
        <ThemedText
          ...
          lightColor={Colors.gray700}
        >
          Pick a starter amount for your showcase wallet.
        </ThemedText>
